...
Para los botones quisimos optar por una idea más distinta con botones en forma de tickets así aludir a las entradas al cine. Buscamos que se mantengan de color dorado y siempre acompañados de texto y no iconos y así diferenciarlos de otros iconos y botones para cosas más particulares.

Los iconos llevan dentro un balde con palomitas sin colores por dentro para mantener la simpleza de la página web muy acorde a lo simple de un guión. Estas hechos en circular y con forma de tickets para probar su uso dependiendo de como se vea mejor en cada categoria.
